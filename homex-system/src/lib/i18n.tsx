...
const translations = {
  ...
  convertContractTitle: { ar: "تحويل العرض إلى عقد", en: "Convert quote to a contract" },
  convertContractDesc: { ar: "سيصبح العرض عقداً مثبّتاً (لا يُعدّل إلا بصلاحية مدير) وينتقل إلى إدارة الأعمال. أدخل تاريخ التسليم المتّفق عليه.", en: "The quote becomes a locked contract (editable only by a manager) and moves to the work board. Enter the agreed delivery date." },
  convertContractCta: { ar: "تأكيد — تحويل إلى عقد", en: "Confirm — convert to contract" },
