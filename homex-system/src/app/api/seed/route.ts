  ...
  try {
    ...
    const categories = [
      { id: "kitchens", nameAr: "المطابخ", nameEn: "Kitchens", icon: "ChefHat", pricingType: "per_sqm", sortOrder: 1,
        config: JSON.stringify({ regions: { muscat: { price: 120 }, batinah: { price: 130 }, other: { price: 150 } }, multipliers: { "2unit": 1, "3unit": 1.3 }, porcelainSurcharge: 55, island: { small: 390, large: 600 } }) },
      ...
      { id: "bed", nameAr: "السرير", nameEn: "Bed", icon: "BedDouble", pricingType: "per_unit", sortOrder: 6,
        config: JSON.stringify({ types: { wood: "خشب", fabric: "قماش" }, sizes: { "90x190": 85, "120x200": 110, "150x200": 130, "160x200": 140, "180x200": 160, "200x200": 180 }, lighting: 20 }) },
    ...
    return NextResponse.json({ success: true, message: "Seed completed: 3 employees, 12 categories, 9 settings" });
  } catch (err: any) {
